...
if __name__ == "__main__":
    ...
    fig_opt.update_layout(title="MR V4 Adaptive Bands — Optimized (Train)", height=900)
    ...
    fig_holdout.update_layout(title="MR V4 Adaptive Bands — Hold-Out Test", height=900)

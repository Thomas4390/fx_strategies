...
PRESET_LINES: list[str] = [
    ...
    f"Inp_DDCap={_ext(0.30, 0.030000, 3.000000)}",
    f"Inp_ResetDDState={_ext(False, 0, 0, is_bool=True)}",
    f"Inp_EnableMarginCap={_ext(False, 0, 0, is_bool=True)}",
    f"Inp_MarginCapPct={_ext(0.7, 0.070000, 7.000000)}",
    "; --- Vol-targeting global (Phase I 2026-05-05 leverage uplift) ---",
    f"Inp_GlobalTargetVol={_ext(0.75, 0.075000, 7.500000)}",
    f"Inp_GlobalMaxLeverage={_ext(64.0, 6.400000, 640.000000)}",

...
PRESET_LINES: list[str] = [
    ...
    ";",
    "; --- Allocation & Risk ---",
    f"Inp_AllocMRMacro={_ext(0.8, 0.080000, 8.000000)}",
    f"Inp_AllocTSMomentum={_ext(0.1, 0.010000, 1.000000)}",
    f"Inp_AllocRSIDaily={_ext(0.1, 0.010000, 1.000000)}",
    f"Inp_EnableDDCap={_ext(True, 0, 0, is_bool=True)}",
    f"Inp_DDCap={_ext(0.15, 0.015000, 1.500000)}",
    f"Inp_ResetDDState={_ext(False, 0, 0, is_bool=True)}",
    f"Inp_EnableMarginCap={_ext(True, 0, 0, is_bool=True)}",
    f"Inp_MarginCapPct={_ext(0.7, 0.070000, 7.000000)}",
    "; --- Vol-targeting global ---",
    f"Inp_GlobalTargetVol={_ext(0.28, 0.028000, 2.800000)}",
    f"Inp_GlobalMaxLeverage={_ext(12.0, 1.200000, 120.000000)}",
    ...
    f"Inp_MR_SessionStart={_ext(6, 1, 60)}",
    f"Inp_MR_SessionEnd={_ext(14, 1, 140)}",
    ...
    "; --- Sleeve 3 — RSI Daily ---",
    "Inp_RSI_Pairs=EURUSD,GBPUSD,USDJPY,USDCAD",

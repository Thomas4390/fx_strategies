...
\subsection{Le spread est constant}
...
soit l'année, faute d'avoir pu mesurer le spread historique sur le flux du
courtier. Ce constant est trop cher en séance liquide et trop bon marché en
heures creuses, et il pèse de moins en moins en proportion à mesure que le
prix de l'or monte.

\emph{Cette limite pourrait-elle renverser le verdict~?} Non. La
section~\ref{sec:x10_couts} montre que même une exécution gratuite laisserait
l'espérance négative. Un spread mieux mesuré déplacerait le chiffre, pas son
signe.
...
absence ne change rien au sens des six critères mesurés.
...
remplissages à l'intérieur de la minute. Les chiffres qu'il produira sont donc
un \textbf{majorant} de ce qu'un compte réel obtiendrait, et ils devront être
lus comme tels.

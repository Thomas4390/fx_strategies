...
\begin{description}
  ...
  clause a un coût immédiat dans ce rapport~: deux des neuf critères sont en
  échec par non-mesure, et ils sont comptés comme tels
...
\XTenSpreadUsd{} l'aller-retour, relevé au catalogue du courtier. Ce repli a
été décidé et gelé avant la campagne, faute de pouvoir mesurer le spread
historique heure par heure~: le terminal ne joint plus le serveur de
démonstration du courtier. En contrepartie, la table de décision rend
\textbf{obligatoire} une sensibilité au doublement du coût, qui s'ajoute à la
sensibilité de référence à une fois et demie.

...
\midrule
Pondéré $72/9/9/10$ \emph{sans levier} & 5.47\,\% & 5.81\,\% & 0.94 & -10.82\,\% \\
Pondéré $72/9/9/10$ \emph{avec} ciblage vol $0.37$ / cap $31\times$ & 40.49\,\% & 36.60\,\% & 1.11 & -58.49\,\% \\
Multiplicateur effectif moyen & \multicolumn{4}{c}{\textbf{6.3$\times$} (rapport volatilité leveragée / non leveragée)} \\
\bottomrule
\end{tabular}
\end{table}

...
relevés dans le journal du testeur.
...
s'élève à $+$44\,926\,\$~; le swap en retire $-$12\,784\,\$. C'est le prix
mécanique de la tenue longue, et il n'est pas modélisé du côté recherche.

\item \textbf{Les deux moteurs occupent les mêmes fenêtres mais découpent
autrement.} Le moteur de recherche (vbt) et celui d'exécution (MT5) sont en
position les mêmes jours à 90\,\% près, pour une exposition identique de
75\,\%. Mais dix positions MT5 sont fractionnées en deux ou trois côté vbt.
L'égalité «~35~trades de part et d'autre~» relevée lors de la réconciliation est
une coïncidence de comptage, pas une correspondance de transactions.
...
\input{tables/gold_trades_summary.tex}

...
{\footnotesize
\input{tables/gold_trades_full.tex}
}
...
\item \code{python scripts/build\_gold\_trades\_figures.py} --- rejoue le
      moteur côté recherche et produit les figures et tables de ce document.

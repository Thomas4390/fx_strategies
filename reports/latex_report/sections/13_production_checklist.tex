...
\item \textbf{Monitoring par moteur, et par instrument sur le Moteur~4}~: calcul du Sharpe glissant sur 63~jours pour chaque moteur individuel, avec alerte si un moteur passe sous 0.5. Le Moteur~4 portant $91\,\%$ du résultat, sa contribution est suivie instrument par instrument (or, dollar-yen, argent). Cela permet de détecter une dégradation structurelle avant que le portefeuille combiné n'en souffre visiblement.

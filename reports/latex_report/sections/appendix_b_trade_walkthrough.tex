...
\item \textbf{Filtre session}~: l'heure courante 10h30~UTC est bien dans la fenêtre de chevauchement Londres~+~New~York (8h--16h~UTC) où la liquidité est maximale.
...
\item La taille de position est calculée à partir du pool de trésorerie alloué au Moteur~1 (62\,\% du portefeuille total) multiplié par le levier global courant, divisé par le prix d'entrée.
\end{enumerate}

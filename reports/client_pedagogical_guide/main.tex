...
\code{Inp\_EnableMarginCap}   & \texttt{false} & Désactivé (jamais déclenché en backtest). \\
\code{Inp\_MarginCapPct}      & $0{,}70$  & À adapter selon la marge dont vous disposez en réserve. \\
\bottomrule
\end{tabular}
\end{center}

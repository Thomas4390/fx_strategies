...
\rowcolor{lightGrey} Moteur 4 --- Gold Momentum & $10\,\%$ & D1 swing & Trend following & XAU/USD \\
\bottomrule
\end{tabular}
\end{center}
...
Univers & EUR/USD, GBP/USD, USD/JPY, USD/CAD & EUR/USD, GBP/USD, USD/JPY & EUR/USD, GBP/USD, USD/CAD & XAU/USD \\
...
Trades / an & $\sim 57$ & $\sim 90$ & $\sim 6$ & $\sim 7$ \\
Win rate & $58\,\%$ & $63\,\%$ & $67\,\%$ & $31\,\%$ \\
Part du P\&L mesuré & $8{,}3\,\%$ & $8{,}8\,\%$ & $3{,}0\,\%$ & $\mathbf{79{,}8\,\%}$ \\
\bottomrule
\end{tabular}
\end{center}

\noindent\footnotesize Chiffres mesurés sur le backtest d'exécution MetaTrader~5 de
référence (2021-01-01 $\rightarrow$ 2026-04-30, $851$~transactions). La dernière ligne est
...
Cette sous-section explique ce qui a été testé et ce qui a été trouvé.
...
Le \emph{swap} est concentré sur les Moteurs~2 et~3 ($-408$ USD à eux deux) ; le Moteur~1 (intraday) le ramène à zéro. Sur un capital initial de \$10\,000, $\$410$ de swap sur 5{,}33~ans représente un drag annuel de l'ordre de $0{,}8\,\%$~--- significatif mais maîtrisé.
